                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                           ...
                           @foreach($messages as $message)
                                    ...
                                    <tr class="odd gradeX" @if(!$message->isRead)style="font-weight: bold"@endif>

                                            <td></td>
                                            <td>{{$message->name}}</td>
                                            <td>{{$message->email}}</td>
                                            <td class="center"><a style="color: black;" href="{{route('message', $message->id)}}">{{$message->message}} </a></td>
